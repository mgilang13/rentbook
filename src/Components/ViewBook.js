...
class ViewBook extends Component {
  ...
  rentBook() {
    const available = 1;
    Axios.patch(URL_STRING_RENT, available).then(res => {
      console.log(res)
    })
    .catch(err => {
      ...
      <DeleteBookModal />
          ...
          <div className="bannerImage">
            <div className="col-sm-5 menu row">
              ...
              <div className="col-sm-3 d-flex align-items-end editDelete">
                <Link to="/editBook" data-toggle="modal" data-target="#editModal">Edit</Link>
                <Link to="/deleteBook" data-toggle="modal" data-target="#deleteModal">Delete</Link>
              </div>
            </div>
          <img
            className="bigBanner"
        ...
        <div className="row mt-4 col mainContent">
          ...
          <div className="col d-flex">
            <button className="col btn btn-lg btn-warning align-self-end text-white" onClick={this.rentBook}>
